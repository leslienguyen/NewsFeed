...
- (id)init
{
    return [self initWithFeedType:FeedTypeEngadget];
}
...
- (void)viewDidLoad 
{
    ...
    //Might add later as a display option
...
//	[segBarItem release];	
	...
	[[FeedDownloader sharedController] downloadFeed:feedType withSuccessBlock:^(NSArray *entries) {
